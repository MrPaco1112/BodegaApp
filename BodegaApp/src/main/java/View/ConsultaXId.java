...
public class ConsultaXId extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        AsistenteFirebase.buscarPorIndice(manager.firebaseDatabase, "Bodega", jTextArea1); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaXId.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
